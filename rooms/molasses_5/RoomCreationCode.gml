if (global.lvldesign == 1)
{
    if global.panic
    {
        ...
        tilemap_tileset(layer_tilemap_get_id(layer_get_id("Tiles_5")), ts_molasses1escapeNEW)
    ...
    else
    {
        ...
        tilemap_tileset(layer_tilemap_get_id(layer_get_id("Tiles_5")), ts_molasses1NEW)
