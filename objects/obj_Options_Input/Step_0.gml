...
{
    scr_getinput()
    ScrollY = lerp(ScrollY, (optionselected / 40 * -100), 0.15)
    if (!selecting)
    {
    ...
    switch optionselected
    {
        ...
        case input_selected.up:
            ...
            if selecting
            {
                if keyboard_check_pressed(vk_anykey)
                {
                    ...
                    selecting = false
                    if instance_exists(obj_Options_Main)
                        obj_Options_Main.optionchanged = true
                }
            }
            if ((key_jump || keyboard_check_pressed(vk_return)) && (!selecting))
            {
                selecting = true
                global.key_up = -1
            }
        ...
        case input_selected.right:
            ...
            if ((key_jump || keyboard_check_pressed(vk_return)) && selecting == 0)
            {
                selecting = true
                global.key_right = -1
            }
