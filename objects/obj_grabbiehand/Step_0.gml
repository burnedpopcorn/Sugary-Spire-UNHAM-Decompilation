...
if (x <= (dropspotx + 5) && x >= (dropspotx - 5) && y <= (dropspoty + 5) && y >= (dropspoty - 5) && (!released) && grabbing)
{
...
if (x <= (xstarte + 6) && x >= (xstarte - 6) && y <= (ystarte + 6) && y >= (ystarte - 6) && grabbing && sprite_index == spr_grabbiehand_idle)
{
    grabbing = false
    released = false
}
