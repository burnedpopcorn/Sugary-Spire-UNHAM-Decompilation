...
if (instance_number(object_index) > 1)
    instance_destroy()
function open()//@gml_Object_obj_shell_Create_0() //open@gml_Object_obj_shell_Create_0
{
    isOpen = true
    keyboard_string = ""
    if (!is_undefined(openFunction))
...
function close()//@gml_Object_obj_shell_Create_0() //close@gml_Object_obj_shell_Create_0
{
    isOpen = false
    if (!is_undefined(closeFunction))
		closeFunction()
    ...
    while (!ds_queue_empty(deferredQueue))
    {
        var args = ds_queue_dequeue(deferredQueue)
		self._execute_script(args, true);
        //args.args._execute_script(true, self)
    }
    if saveHistory
		self._save_history()
...
function _close_autocomplete()//@gml_Object_obj_shell_Create_0() //_close_autocomplete@gml_Object_obj_shell_Create_0
{
    array_resize(filteredSuggestions, 0)
}
...
function _update_filtered_suggestions()//@gml_Object_obj_shell_Create_0() //_update_filtered_suggestions@gml_Object_obj_shell_Create_0
{
    array_resize(filteredSuggestions, 0)
    autocompleteMaxWidth = 0
    suggestionIndex = 0
...
function _find_common_prefix()//@gml_Object_obj_shell_Create_0() //_find_common_prefix@gml_Object_obj_shell_Create_0
{
    if (array_length(filteredSuggestions) == 0)
        return "";
    var first = string(filteredSuggestions[0])
...
function _key_combo_pressed(argument0, argument1)//@gml_Object_obj_shell_Create_0(argument0, argument1) //_key_combo_pressed@gml_Object_obj_shell_Create_0
{
...
delayFrame = 0
delayFrames = 1
function _keyboard_check_delay(argument0)//@gml_Object_obj_shell_Create_0(argument0) //_keyboard_check_delay@gml_Object_obj_shell_Create_0
{
...
function _shell_properties_hash()//@gml_Object_obj_shell_Create_0() //_shell_properties_hash@gml_Object_obj_shell_Create_0
{
...
function _recalculate_shell_properties()//@gml_Object_obj_shell_Create_0() //_recalculate_shell_properties@gml_Object_obj_shell_Create_0
{
    var screenCenterX = display_get_gui_width() / 2
    var screenCenterY = display_get_gui_height() / 2
    draw_set_font(consoleFont)
...
function _calculate_scroll_from_suggestion_index()//@gml_Object_obj_shell_Create_0() //_calculate_scroll_from_suggestion_index@gml_Object_obj_shell_Create_0
{
    if (suggestionIndex == 0)
        autocompleteScrollPosition = 0
...
function _confirm_current_suggestion()//@gml_Object_obj_shell_Create_0() //_confirm_current_suggestion@gml_Object_obj_shell_Create_0
{
    spaceCount = string_count(" ", consoleString)
    consoleString = ""
    for (i = 0; i < spaceCount; i++)
...
function _confirm_current_mouse_argument_data()//@gml_Object_obj_shell_Create_0() //_confirm_current_mouse_argument_data@gml_Object_obj_shell_Create_0
{
    if (activeMouseArgValue != "")
    {
        consoleString += (string(activeMouseArgValue) + " ")
...
function _execute_script(argument0, argument1)//@gml_Object_obj_shell_Create_0(argument0, argument1) //_execute_script@gml_Object_obj_shell_Create_0
{
...
function _update_positions()//@gml_Object_obj_shell_Create_0() //_update_positions@gml_Object_obj_shell_Create_0
{
    historyPos = array_length(history)
    consoleString = ""
    savedConsoleString = ""
...
function _save_history()//@gml_Object_obj_shell_Create_0() //_save_history@gml_Object_obj_shell_Create_0
{
    var truncatedHistory = []
    var truncatedOutput = []
...
function _load_history()//@gml_Object_obj_shell_Create_0() //_load_history@gml_Object_obj_shell_Create_0
{
...
function _input_string_split(argument0)//@gml_Object_obj_shell_Create_0(argument0) //_input_string_split@gml_Object_obj_shell_Create_0
{
    var slot = 0
    var splits = []
    var str2 = ""
...
function _remap(argument0, argument1, argument2, argument3, argument4)//@gml_Object_obj_shell_Create_0(argument0, argument1, argument2, argument3, argument4) //_remap@gml_Object_obj_shell_Create_0
{
