if (ds_list_find_index(global.saveroom, id) == -1)
{
    ...
    repeat rep
    {
        with (instance_create((x + (random_range(0, sprite_width))), (y + (random_range(0, sprite_height))), obj_debris2))
            sprite_index = spr_smallbreakEscape_Debris
    }
    repeat floor(rep / 2)
        instance_create((x + (random_range(0, sprite_width))), (y + (random_range(0, sprite_height))), obj_debris2)
