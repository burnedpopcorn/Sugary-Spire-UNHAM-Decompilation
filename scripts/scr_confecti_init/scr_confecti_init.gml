function scr_confecti_init() //scr_confecti_init
{
    ...
    switch object_index
    {
        case obj_confectichoco:
            ...
            scr_queue_tvanim(obj_tv.confectitv2, 100)
            break
        case obj_confecticrack:
            ...
            scr_queue_tvanim(obj_tv.confectitv3, 100)
            break
        case obj_confectiworm:
            ...
            scr_queue_tvanim(obj_tv.confectitv4, 100)
            break
        case obj_confecticandy:
            ...
            scr_queue_tvanim(obj_tv.confectitv5, 100)
            break
        case obj_rudejanitorfollow:
            ...
            scr_queue_tvanim(spr_pizzytv_rude, 100)
            break
        default:
            ...
            scr_queue_tvanim(obj_tv.confectitv1, 100)
            break
    }
