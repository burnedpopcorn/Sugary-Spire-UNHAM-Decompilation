function scr_confecti_normal() //scr_confecti_normal
{
    ...
    x = targetx
    y = targety
    if (obj_player.state == states.backbreaker && (obj_player.sprite_index == spr_pizzelle_taunt || obj_player.sprite_index == spr_pizzano_taunt) && state != confectistates.taunt)
    {
