...
{
    var finished, _gnome, target_x;
    
    finished = false;
    _gnome = cutscene_get_actor("GNOMECHOMPSKI");
    target_x = _gnome.x - (60 * sign(_gnome.image_xscale));
...
/*
function cutscene_gnomeMines_start() //cutscene_gnomeMines_start
{
    var finished = false
...
function cutscene_gnomeMines_middle() //cutscene_gnomeMines_middle
{
    finished = false
    _gnome = cutscene_get_actor("GNOMECHOMPSKI")
    with (obj_player)
...
function cutscene_gnomeMines_end() //cutscene_gnomeMines_end
{
    global.treat = false
    with (obj_player)
        state = states.normal
