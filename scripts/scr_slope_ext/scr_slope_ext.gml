...
{
    var old_x, old_y, slope, object_side, slope_start, slope_end, m, sslope, platformslope, platobject_side, platslope_start, platslope_end, n, slopeplatforms;
    ...
    if (place_meeting(x, y, obj_slopeplatform))
    {
        ...
        with (platformslope)
        {
            ...
            slopeplatforms = platslope_start - round(n * (platobject_side - bbox_left));
