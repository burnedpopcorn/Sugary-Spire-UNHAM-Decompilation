function scr_player_comingoutdoor()
{
    ...
    if (place_meeting(x, y, obj_door) || place_meeting(x, y, obj_exitgate) || place_meeting(x, y, obj_keydoor) || place_meeting(x, y, obj_keydoorclock) || place_meeting(x, y, obj_startgate))
    {
